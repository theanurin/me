...
const siteConfig = {
	...
	// analytics: {
	// 	umami: {
	// 		umamiInstanceUrl: "https://umami.infra.anurin.name",
	// 		websiteId: "1d7fe2cc-1c86-4633-9549-c33f6e4d8e5a",
	// 	},
	// },
};
	...
	eleventyConfig.addGlobalData("site", {
		...
		...(buildAnalyticsUnamiInstanceUrl && buildAnalyticsUnamiWebsiteId
			? {
					analytics: {
						umami: {
							umamiInstanceUrl: buildAnalyticsUnamiInstanceUrl,
							websiteId: buildAnalyticsUnamiWebsiteId,
						},
					},
				}
			: {}),
